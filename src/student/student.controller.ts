...
import { ApiBadRequestResponse, ApiHeader, ApiHeaders, ApiOkResponse, ApiResponse, ApiTags } from '@nestjs/swagger';
...
export class StudentController {
  ...
  @ApiResponse({status:500, description: ErrorMessages.APPLICATION_ERROR})
  @ApiHeader({name: 'Authorization',description: 'Token generated by authentication microservice',required: true})
